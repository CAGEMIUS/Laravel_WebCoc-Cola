...
<html lang="en">
    ...
    <body>
        ...
        <nav class="categorias">
            <img src="{{ asset('img/gifservicecliet.gif') }}" alt="gif">
        ...
        <div class="calls">
            <img src="{{ asset('img/ICONOWASAP.png') }}" alt="No. WhatsApp">
            <h2>312-560-88-36</h2>
        </div>
        <div class="calls">
            <img src="{{ asset('img/ICONOTELEFONO.png') }}" alt="No. Telefono">
            <h2>601-460-24-13</h2>
        </div>
        <div class="calls">
            <img src="{{ asset('img/ICONOGMAIL.png') }}" alt="Gmail">
